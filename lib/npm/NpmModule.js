...
class NpmModule extends Module
{
    ...
    getJsonLd (output)
    {
        return NpmContext.addContext(this).then(json =>
        {
            ...
            // TODO: UGLY!
            let ignore = ['npm:maxSatisfying', 'spdx:licenseInfoFromFiles', 'dcterms:license'];
            ...
            ignore.push('spdx:checksumValue', 'spdx:algorithm');
            ...
            NpmContext.updateUnusedValues(json, ignore);
